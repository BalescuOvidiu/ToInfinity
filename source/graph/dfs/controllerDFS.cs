...
public class controllerDFS : MonoBehaviour {
    ...
    public bool pressed;
    public nod_controlDFS NC;
    public muchie_controlDFS MC;
    ...
    public void adauga_muchie(Vector2 X, Vector2 Y, int x, int y)
    {
        ...
        MC = muchieAux.GetComponent<muchie_controlDFS>();
    ...
    public void ad()    //functia adauga un nod
    {
        ...
        NC = nod.GetComponent<nod_controlDFS>();
        NC.numar = x;
